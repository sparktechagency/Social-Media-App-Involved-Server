...
router.patch('/add-profileImage', auth('common'), [uploadUsers.single("profileImage")], authController.addProfileImage);
router.patch('/favorite-events', auth('common'), authController.favoriteEvents);
